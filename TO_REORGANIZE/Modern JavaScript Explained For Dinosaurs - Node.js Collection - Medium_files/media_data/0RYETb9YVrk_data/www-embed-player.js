...
;function Fg(){var a=new Rd;(a=a.isAvailable()?new Xd(a,"yt.innertube"):null)||(a=new Sd("yt.innertube"),a=a.isAvailable()?a:null);this.f=a?new Nd(a):null;this.g=document.domain||window.location.hostname}
Fg.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.f)try{this.f.set(a,b,D()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(jd(b))}catch(f){return}else e=escape(b);Eg(a,e,c,this.g)};
...
function Vg(a){a=void 0===a?0:a;var b=P(Rg(a));b||0!=a||(Q("kevlar_client_side_screens")||Q("c3_client_side_screens")?b="UNDEFINED_CSN":b=P("EVENT_ID"));return b?b:null}
x("yt_logging_screen.getCurrentCsn",Vg,void 0);function Wg(a,b,c){c=void 0===c?0:c;if(a!==P(Rg(c))||b!==P(Sg(c)))O(Rg(c),a),O(Sg(c),b),0==c&&(b=function(){setTimeout(function(){a&&Ag("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:Ng,clientScreenNonce:a},Kg)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b())}
x("yt_logging_screen.setCurrentScreen",Wg,void 0);function Xg(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=P("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=P("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=J(K(3,window.location.href));g&&f.push(g);g=J(K(3,d));if(0<=La(f,g)||!g&&0==d.lastIndexOf("/",0))if(Q("autoescape_tempdata_url")&&(f=document.createElement("a"),Kb(f,d),d=f.href),d){g=d.match(kc);d=g[5];f=g[6];g=g[7];var h="";d&&(h+=d);f&&(h+="?"+f);g&&(h+="#"+g);d=h;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&!b.csn&&(b.itct||
b.ved)&&(b=Object.assign({csn:Vg()},b)),k){var k=parseInt(k,10);isFinite(k)&&0<k&&(e=b,b="ST-"+Nb(d).toString(36),e=e?mc(e):"",Eg(b,e,k||5))}else k=b,e="ST-"+Nb(d).toString(36),k=k?mc(k):"",Eg(e,k,5)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var p=void 0===p?"":p;var n=void 0===n?window:n;c=n.location;a=nc(a,l)+p;a=a instanceof H?a:Ab(a);c.href=yb(a)}return!0}
;function Yg(a,b){this.version=a;this.args=b}
;function Zg(a,b){this.topic=a;this.f=b}
Zg.prototype.toString=function(){return this.topic};var $g=z("ytPubsub2Pubsub2Instance")||new N;N.prototype.subscribe=N.prototype.subscribe;N.prototype.unsubscribeByKey=N.prototype.N;N.prototype.publish=N.prototype.M;N.prototype.clear=N.prototype.clear;x("ytPubsub2Pubsub2Instance",$g,void 0);var ah=z("ytPubsub2Pubsub2SubscribedKeys")||{};x("ytPubsub2Pubsub2SubscribedKeys",ah,void 0);var bh=z("ytPubsub2Pubsub2TopicToKeys")||{};x("ytPubsub2Pubsub2TopicToKeys",bh,void 0);var ch=z("ytPubsub2Pubsub2IsAsync")||{};x("ytPubsub2Pubsub2IsAsync",ch,void 0);
x("ytPubsub2Pubsub2SkipSubKey",null,void 0);function dh(a,b){var c=eh();c&&c.publish.call(c,a.toString(),a,b)}
function fh(a){var b=gh,c=eh();if(!c)return 0;var d=c.subscribe(b.toString(),function(e,f){var g=z("ytPubsub2Pubsub2SkipSubKey");g&&g==d||(g=function(){if(ah[d])try{if(f&&b instanceof Zg&&b!=e)try{var h=b.f,k=f;if(!k.args||!k.version)throw Error("yt.pubsub2.Data.deserialize(): serializedData is incomplete.");try{if(!h.F){var l=new h;h.F=l.version}var p=h.F}catch(n){}if(!p||k.version!=p)throw Error("yt.pubsub2.Data.deserialize(): serializedData version is incompatible.");try{f=Reflect.construct(h,
Ra(k.args))}catch(n){throw n.message="yt.pubsub2.Data.deserialize(): "+n.message,n;}}catch(n){throw n.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+b.toString()+": "+n.message,n;}a.call(window,f)}catch(n){je(n)}},ch[b.toString()]?z("yt.scheduler.instance")?yf(g):R(g,0):g())});
ah[d]=!0;bh[b.toString()]||(bh[b.toString()]=[]);bh[b.toString()].push(d);return d}
function hh(){var a=ih,b=fh(function(c){a.apply(void 0,arguments);jh(b)});
return b}
function jh(a){var b=eh();b&&("number"===typeof a&&(a=[a]),G(a,function(c){b.unsubscribeByKey(c);delete ah[c]}))}
function eh(){return z("ytPubsub2Pubsub2Instance")}
;function kh(a){Yg.call(this,1,arguments);this.csn=a}
t(kh,Yg);var gh=new Zg("screen-created",kh),lh=[],mh=0;function nh(a,b,c){b={csn:a,parentVe:Pg(b),childVes:Na(c,function(e){return Pg(e)})};
c=r(c);for(var d=c.next();!d.done;d=c.next())d=Pg(d.value),(Ya(d)||!d.trackingParams&&!d.veType)&&Xe(Error("Child VE logged with no data"),"WARNING");c={ca:void 0,P:a};"UNDEFINED_CSN"==a?oh("visualElementAttached",b,c):Ag("visualElementAttached",b,Kg,c)}
function oh(a,b,c){lh.push({Ma:a,payload:b,options:c});mh||(mh=hh())}
function ih(a){if(lh){for(var b=r(lh),c=b.next();!c.done;c=b.next())c=c.value,c.payload&&(c.payload.csn=a.csn,Ag(c.Ma,c.payload,null,c.options));lh.length=0}mh=0}
;function ph(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||ab(b);this.assets=a.assets||{};this.attrs=a.attrs||ab(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
ph.prototype.clone=function(){var a=new ph,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==Aa(c)?a[b]=ab(c):a[b]=c}return a};function qh(){L.call(this);this.f=[]}
t(qh,L);qh.prototype.m=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.nb)}L.prototype.m.call(this)};var rh=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function sh(a){a=a||"";if(window.spf){var b=a.match(rh);spf.style.load(a,b?b[1]:"",void 0)}else th(a)}
function th(a){var b=uh(a),c=document.getElementById(b),d=c&&bf(c,"loaded");d||c&&!d||(c=vh(a,b,function(){bf(c,"loaded")||($e(c),lf(b),R(Ia(mf,b),0))}))}
...
function uh(a){var b=ec(document,"A");Kb(b,new H(wb,a));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Nb(a)}
;function wh(a,b,c,d){L.call(this);var e=this;this.l=this.X=a;this.U=b;this.w=!1;this.api={};this.V=this.G=null;this.H=new N;Uc(this,Ia(Vc,this.H));this.i={};this.R=this.W=this.h=this.ba=this.f=null;this.K=!1;this.j=this.B=null;this.Y={};this.ta=["onReady"];this.aa=null;this.ja=NaN;this.S={};this.o=d;xh(this);this.Z("WATCH_LATER_VIDEO_ADDED",this.Ja.bind(this));this.Z("WATCH_LATER_VIDEO_REMOVED",this.Ka.bind(this));this.Z("onAdAnnounce",this.va.bind(this));this.ua=new qh(this);Uc(this,Ia(Vc,this.ua));
this.T=0;c?this.T=R(function(){e.loadNewVideoConfig(c)},0):d&&(yh(this),zh(this))}
t(wh,L);m=wh.prototype;m.getId=function(){return this.U};
m.loadNewVideoConfig=function(a){if(!this.g){this.T&&(S(this.T),this.T=0);a instanceof ph||(a=new ph(a));this.ba=a;this.f=a.clone();yh(this);this.W||(this.W=Ah(this,this.f.args.jsapicallback||"onYouTubePlayerReady"));this.f.args.jsapicallback=null;if(a=this.f.attrs.width)this.l.style.width=vc(Number(a)||a);if(a=this.f.attrs.height)this.l.style.height=vc(Number(a)||a);zh(this);this.w&&Bh(this)}};
function yh(a){var b;a.o?b=a.o.rootElementId:b=a.f.attrs.id;a.h=b||a.h;"video-player"==a.h&&(a.h=a.U,a.f.attrs.id=a.U);a.l.id==a.h&&(a.h+="-player",a.f.attrs.id=a.h)}
m.ya=function(){return this.ba};
function Bh(a){a.f&&!a.f.loaded&&(a.f.loaded=!0,"0"!=a.f.args.autoplay?a.api.loadVideoByPlayerVars(a.f.args):a.api.cueVideoByPlayerVars(a.f.args))}
function Ch(a){var b=!0,c=Dh(a);c&&a.f&&(a=Eh(a),b=bf(c,"version")===a);return b&&!!z("yt.player.Application.create")}
function zh(a){if(!a.g&&!a.K){var b=Ch(a);if(b&&"html5"==(Dh(a)?"html5":null))a.R="html5",a.w||Fh(a);else if(Gh(a),a.R="html5",b&&a.j)a.X.appendChild(a.j),Fh(a);else{a.f&&(a.f.loaded=!0);var c=!1;a.B=function(){c=!0;var d=z("yt.player.Application.create"),e=a.f?a.f.clone():void 0;d(a.X,e,a.o);Fh(a)};
a.K=!0;b?a.B():(qf(Eh(a),a.B),sh(a.o?a.o.cssUrl:a.f.assets.css),Hh(a)&&!c&&x("yt.player.Application.create",null,void 0))}}}
function Dh(a){var b=ac(a.h);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.h));return b}
function Fh(a){if(!a.g){var b=Dh(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.K=!1,b.isNotServable&&a.f&&b.isNotServable(a.f.args.video_id)||Ih(a)):a.ja=R(function(){Fh(a)},50)}}
function Ih(a){xh(a);a.w=!0;var b=Dh(a);b.addEventListener&&(a.G=Jh(a,b,"addEventListener"));b.removeEventListener&&(a.V=Jh(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.api[e]||(a.api[e]=Jh(a,b,e))}for(var f in a.i)a.G(f,a.i[f]);Bh(a);a.W&&a.W(a.api);a.H.M("onReady",a.api)}
function Jh(a,b,c){var d=b[c];return function(){try{return a.aa=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.params=c,a.aa=e,ke(e))}}}
function xh(a){a.w=!1;if(a.V)for(var b in a.i)a.V(b,a.i[b]);for(var c in a.S)S(parseInt(c,10));a.S={};a.G=null;a.V=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.Z.bind(a);a.api.removeEventListener=a.Pa.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.za.bind(a);a.api.getPlayerType=a.Aa.bind(a);a.api.getCurrentVideoConfig=a.ya.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.Ia.bind(a)}
m.Ia=function(){return this.w};
m.Z=function(a,b){var c=this,d=Ah(this,b);if(d){if(!(0<=La(this.ta,a)||this.i[a])){var e=Kh(this,a);this.G&&this.G(a,e)}this.H.subscribe(a,d);"onReady"==a&&this.w&&R(function(){d(c.api)},0)}};
m.Pa=function(a,b){if(!this.g){var c=Ah(this,b);c&&Hd(this.H,a,c)}};
function Ah(a,b){var c=b;if("string"==typeof b){if(a.Y[b])return a.Y[b];c=function(){var d=z(b);d&&d.apply(w,arguments)};
a.Y[b]=c}return c?c:null}
function Kh(a,b){var c="ytPlayer"+b+a.U;a.i[b]=c;w[c]=function(d){var e=R(function(){if(!a.g){a.H.M(b,d);var f=a.S,g=String(e);g in f&&delete f[g]}},0);
Za(a.S,String(e))};
return c}
...
m.Aa=function(){return this.R||(Dh(this)?"html5":null)};
m.za=function(){return this.aa};
function Gh(a){a.cancel();xh(a);a.R=null;a.f&&(a.f.loaded=!1);var b=Dh(a);b&&(Ch(a)||!Hh(a)?a.j=b:(b&&b.destroy&&b.destroy(),a.j=null));for(a=a.X;b=a.firstChild;)a.removeChild(b)}
m.cancel=function(){this.B&&wf(Eh(this),this.B);S(this.ja);this.K=!1};
m.m=function(){Gh(this);if(this.j&&this.f&&this.j.destroy)try{this.j.destroy()}catch(b){je(b)}this.Y=null;for(var a in this.i)w[this.i[a]]=null;this.ba=this.f=this.api=null;delete this.X;delete this.l;L.prototype.m.call(this)};
function Hh(a){return a.f&&a.f.args&&a.f.args.fflags?-1!=a.f.args.fflags.indexOf("player_destroy_old_version=true"):!1}
function Eh(a){return a.o?a.o.jsUrl:a.f.assets.js}
;var Lh={},Mh="player_uid_"+(1E9*Math.random()>>>0);function Nh(a){delete Lh[a.getId()]}
;var Oh=window,X=Oh.performance||Oh.mozPerformance||Oh.msPerformance||Oh.webkitPerformance||{};function Ph(a,b){Yg.call(this,1,arguments)}
t(Ph,Yg);function Qh(a,b){Yg.call(this,1,arguments)}
t(Qh,Yg);var Rh=new Zg("aft-recorded",Ph),Sh=new Zg("timing-sent",Qh);var Th=!1;function Uh(){var a=Vh(void 0);if(a.aft)return a.aft;for(var b=P("TIMING_AFT_KEYS",["ol"]),c=b.length,d=0;d<c;d++){var e=a[b[d]];if(e)return e}return NaN}
function Wh(a){var b;(b=z("ytcsi."+(a||"")+"data_"))||(b={tick:{},info:{}},Ka("ytcsi."+(a||"")+"data_",b));return b}
function Xh(){var a=Wh(void 0);a.info||(a.info={});return a.info}
function Vh(a){a=Wh(a);a.tick||(a.tick={});return a.tick}
function Yh(){var a=Wh(void 0).nonce;a||(a=Mg(),Wh(void 0).nonce=a);return a}
function Zh(){var a=Vh(""),b=Uh();b&&!Th&&(dh(Rh,new Ph(Math.round(b-a._start),void 0)),Th=!0)}
;function $h(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];if(!ai(a)||c.some(function(e){return!ai(e)}))throw Error("Only objects may be merged.");
c=r(c);for(d=c.next();!d.done;d=c.next())bi(a,d.value);return a}
function bi(a,b){for(var c in b)if(ai(b[c])){if(c in a&&!ai(a[c]))throw Error("Cannot merge an object into a non-object.");c in a||(a[c]={});bi(a[c],b[c])}else if(ci(b[c])){if(c in a&&!ci(a[c]))throw Error("Cannot merge an array into a non-array.");c in a||(a[c]=[]);di(a[c],b[c])}else a[c]=b[c];return a}
function di(a,b){for(var c=r(b),d=c.next();!d.done;d=c.next())d=d.value,ai(d)?a.push(bi({},d)):ci(d)?a.push(di([],d)):a.push(d);return a}
function ai(a){return"object"===typeof a&&!Array.isArray(a)}
function ci(a){return"object"===typeof a&&Array.isArray(a)}
;function ei(){var a=z("ytcsi.debug");a||(a=[],x("ytcsi.debug",a,void 0),x("ytcsi.reference",{},void 0));return a}
function fi(){var a=z("ytcsi.reference");a||(ei(),a=z("ytcsi.reference"));if(a[""])return a[""];var b={timerName:"",info:{},tick:{}};ei().push(b);return a[""]=b}
;function gi(a,b,c){c=void 0===c?{}:c;var d=Kg;P("ytLoggingEventsDefaultDisabled",!1)&&Kg==Kg&&(d=null);Ag(a,b,d,c)}
;var hi=z("ytLoggingLatencyUsageStats_")||{};x("ytLoggingLatencyUsageStats_",hi,void 0);function ii(){this.f=0}
function ji(){ii.f||(ii.f=new ii);return ii.f}
ii.prototype.tick=function(a,b,c){ki(this,"tick_"+a+"_"+b)||gi("latencyActionTicked",{tickName:a,clientActionNonce:b},{timestamp:c})};
ii.prototype.info=function(a,b){var c=Object.keys(a).join("");ki(this,"info_"+c+"_"+b)||(a.clientActionNonce=b,gi("latencyActionInfo",a))};
function ki(a,b){hi[b]=hi[b]||{count:0};var c=hi[b];c.count++;c.time=T();a.f||(a.f=zf(a.g,0,5E3));if(5<c.count){if(6===c.count&&1>1E5*Math.random())if(c=new Te("CSI data exceeded logging limit with key"),c.params={key:b},0===b.indexOf("info")){var d=z("yt.logging.errors.log");d?d(c,"WARNING",void 0,void 0,void 0,void 0):(d=be(),d.push([c,"WARNING",void 0,void 0,void 0,void 0]),O("ERRORS",d))}else(d=z("yt.logging.errors.log"))?d(c,"ERROR",void 0,void 0,void 0,void 0):(d=be(),d.push([c,"ERROR",void 0,
void 0,void 0,void 0]),O("ERRORS",d));return!0}return!1}
ii.prototype.g=function(){var a=T(),b;for(b in hi)hi[b]&&6E4<a-hi[b].time&&delete hi[b];this&&(this.f=0)};var Y={},li=(Y.ad_allowed="adTypesAllowed",Y.yt_abt="adBreakType",Y.ad_cpn="adClientPlaybackNonce",Y.ad_docid="adVideoId",Y.yt_ad_an="adNetworks",Y.ad_at="adType",Y.browse_id="browseId",Y.p="httpProtocol",Y.t="transportProtocol",Y.cpn="clientPlaybackNonce",Y.cseg="creatorInfo.creatorSegment",Y.csn="clientScreenNonce",Y.docid="videoId",Y.GetHome_rid="getHomeRequestId",Y.GetSearch_rid="getSearchRequestId",Y.GetPlayer_rid="getPlayerRequestId",Y.GetWatchNext_rid="getWatchNextRequestId",Y.GetBrowse_rid=
...
Y.label="tvInfo.label",Y.is_mdx="tvInfo.isMdx",Y.preloaded="tvInfo.isPreloaded",Y.upg_player_vis="playerInfo.visibilityState",Y.query="unpluggedInfo.query",Y.upg_chip_ids_string="unpluggedInfo.upgChipIdsString",Y.yt_vst="videoStreamType",Y.vph="viewportHeight",Y.vpw="viewportWidth",Y.yt_vis="isVisible",Y.rcl="mwebInfo.responseContentLength",Y.GetSettings_rid="mwebInfo.getSettingsRequestId",Y.GetTrending_rid="mwebInfo.getTrendingRequestId",Y),mi="isContinuation isNavigation kabukiInfo.earlyBrowseRequestInfo.adopted kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),
ni={},oi=(ni.mver="MEASUREMENT_VERSION_",ni.pis="PLAYER_INITIALIZED_STATE_",ni.yt_pt="LATENCY_PLAYER_",ni.pa="LATENCY_ACTION_",ni.yt_vst="VIDEO_STREAM_TYPE_",ni),pi="all_vc ap c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetBrowse_rid GetHistory_rid GetPlayer_rid GetSearch_rid GetWatchNext_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");
function qi(){return!!P("FORCE_CSI_ON_GEL",!1)||Q("csi_on_gel")||!!Wh(void 0).useGel}
function ri(){var a=Wh(void 0);if(!("gel"in a))a.gel={gelTicks:{},gelInfos:{}};else if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}return a.gel}
;C(X.clearResourceTimings||X.webkitClearResourceTimings||X.mozClearResourceTimings||X.msClearResourceTimings||X.oClearResourceTimings||ya,X);function si(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
function ti(a,b,c){"string"===typeof a&&(a={mediaContentUrl:a,startSeconds:b,suggestedQuality:c});b=/\/([ve]|embed)\/([^#?]+)/.exec(a.mediaContentUrl);a.videoId=b&&b[2]?b[2]:null;return ui(a)}
function ui(a,b,c){if(B(a)){b=["endSeconds","startSeconds","mediaContentUrl","suggestedQuality","videoId"];c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function vi(a,b,c,d){if(B(a)&&!Ba(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};"string"===typeof a&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
;function wi(a){a=void 0===a?!1:a;L.call(this);this.f=new N(a);Uc(this,Ia(Vc,this.f))}
E(wi,L);wi.prototype.subscribe=function(a,b,c){return this.g?0:this.f.subscribe(a,b,c)};
...
t(xi,wi);function yi(a,b,c){if(!a.g){var d=a.h;d.g||a.i!=d.f||(a={id:a.l,command:b},c&&(a.data=c),d.f.postMessage(jd(a),d.i))}}
xi.prototype.m=function(){this.i=this.h=null;wi.prototype.m.call(this)};function zi(a){L.call(this);this.f=a;this.f.subscribe("command",this.ra,this);this.h={};this.j=!1}
t(zi,L);m=zi.prototype;m.start=function(){this.j||this.g||(this.j=!0,yi(this.f,"RECEIVING"))};
m.ra=function(a,b,c){if(this.j&&!this.g){var d=b||{};switch(a){case "addEventListener":"string"===typeof d.event&&(a=d.event,a in this.h||(c=C(this.Ra,this,a),this.h[a]=c,this.addEventListener(a,c)));break;case "removeEventListener":"string"===typeof d.event&&Ai(this,d.event);break;default:this.i.isReady()&&this.i.isExternalMethodAvailable(a,c||null)&&(b=Bi(a,b||{}),c=this.i.handleExternalCall(a,b,c||null),(c=Ci(a,c))&&this.j&&!this.g&&yi(this.f,a,c))}}};
m.Ra=function(a,b){this.j&&!this.g&&yi(this.f,a,this.ea(a,b))};
m.ea=function(a,b){if(null!=b)return{value:b}};
function Ai(a,b){b in a.h&&(a.removeEventListener(b,a.h[b]),delete a.h[b])}
m.m=function(){var a=this.f;a.g||Hd(a.f,"command",this.ra,this);this.f=null;for(var b in this.h)Ai(this,b);L.prototype.m.call(this)};function Di(a,b){zi.call(this,b);this.i=a;this.start()}
t(Di,zi);Di.prototype.addEventListener=function(a,b){this.i.addEventListener(a,b)};
Di.prototype.removeEventListener=function(a,b){this.i.removeEventListener(a,b)};
function Bi(a,b){switch(a){case "loadVideoById":return b=ui(b),[b];case "cueVideoById":return b=ui(b),[b];case "loadVideoByPlayerVars":return[b];case "cueVideoByPlayerVars":return[b];case "loadPlaylist":return b=vi(b),[b];case "cuePlaylist":return b=vi(b),[b];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];case "setLoop":return[b.loopPlaylists];
...
Di.prototype.ea=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return zi.prototype.ea.call(this,a,b)};
Di.prototype.m=function(){zi.prototype.m.call(this);delete this.i};function Ei(a,b,c){L.call(this);var d=this;c=c||P("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.h=b||null;this.w="*";this.i=c;this.sessionId=null;this.channel="widget";this.B=!!a;this.o=function(e){a:if(!("*"!=d.i&&e.origin!=d.i||d.h&&e.source!=d.h||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.B&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
t(Ei,L);Ei.prototype.sendMessage=function(a,b){var c=b||this.h;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=JSON.stringify(a);c.postMessage(d,this.w)}catch(e){ke(e)}}};
Ei.prototype.m=function(){window.removeEventListener("message",this.o);L.prototype.m.call(this)};function Fi(){var a=this.g=new Ei(!!P("WIDGET_ID_ENFORCE")),b=C(this.Oa,this);a.j=b;a.l=null;this.g.channel="widget";if(a=P("WIDGET_ID"))this.g.sessionId=a;this.i=[];this.l=!1;this.j={}}
m=Fi.prototype;m.Oa=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.j[a]||"onReady"==a||(this.addEventListener(a,Gi(this,a)),this.j[a]=!0)):this.ma(a,b,c)};
m.ma=function(){};
function Gi(a,b){return C(function(c){this.sendMessage(b,c)},a)}
...
m.dispose=function(){this.g=null};function Ii(a){Fi.call(this);this.f=a;this.h=[];this.addEventListener("onReady",C(this.La,this));this.addEventListener("onVideoProgress",C(this.Va,this));this.addEventListener("onVolumeChange",C(this.Wa,this));this.addEventListener("onApiChange",C(this.Qa,this));this.addEventListener("onPlaybackQualityChange",C(this.Sa,this));this.addEventListener("onPlaybackRateChange",C(this.Ta,this));this.addEventListener("onStateChange",C(this.Ua,this));this.addEventListener("onWebglSettingsChanged",C(this.Xa,
this))}
t(Ii,Fi);m=Ii.prototype;m.ma=function(a,b,c){if(this.f.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&si(a)){var d=b;if(B(d[0])&&!Ba(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=ui.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=ti.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=vi.apply(window,d)}d=e}b.length=1;b[0]=d}this.f.handleExternalCall(a,b,c);si(a)&&Hi(this,this.fa())}};
...
m.Va=function(a){a={currentTime:a,videoBytesLoaded:this.f.getVideoBytesLoaded(),videoLoadedFraction:this.f.getVideoLoadedFraction(),currentTimeLastUpdated_:D()/1E3,playbackRate:this.f.getPlaybackRate(),mediaReferenceTime:this.f.getMediaReferenceTime()};this.f.getProgressState&&(a.progressState=this.f.getProgressState());Hi(this,a)};
m.Xa=function(){var a={sphericalProperties:this.f.getSphericalProperties()};Hi(this,a)};
m.dispose=function(){Fi.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function Ji(a,b,c){L.call(this);this.f=a;this.i=c;this.j=V(window,"message",C(this.l,this));this.h=new xi(this,a,b);Uc(this,Ia(Vc,this.h))}
t(Ji,L);Ji.prototype.l=function(a){var b;if(b=!this.g)if(b=a.origin==this.i)a:{b=this.f;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,"string"===typeof b)){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.h,c.g||c.j("command",b.command,b.data,a.origin))}};
Ji.prototype.m=function(){Xf(this.j);this.f=null;L.prototype.m.call(this)};function Ki(){var a=ab(Li),b;return wd(new M(function(c,d){a.onSuccess=function(e){xe(e)?c(e):d(new Mi("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
a.onError=function(e){d(new Mi("Unknown request error","net.unknown",e))};
a.O=function(e){d(new Mi("Request timed out","net.timeout",e))};
...
Ni.prototype.then=function(a,b,c){return 1===this.g&&a?(a=a.call(c,this.f),pd(a)?a:Oi(a)):2===this.g&&b?(a=b.call(c,this.f),pd(a)?a:Pi(a)):this};
...
;function Qi(a){F.call(this,a.message||a.description||a.name);this.isMissing=a instanceof Ri;this.isTimeout=a instanceof Mi&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof xd}
t(Qi,F);Qi.prototype.name="BiscottiError";function Ri(){F.call(this,"Biscotti ID is missing from server")}
t(Ri,F);Ri.prototype.name="BiscottiMissingError";var Li={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Si=null;function ee(){if("1"===Va(ce(),"args","privembed"))return ud(Error("Biscotti ID is not available in private embed mode"));Si||(Si=wd(Ki().then(Ti),function(a){return Ui(2,a)}));
return Si}
function Ti(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new Ri;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new Ri;a=a.id;fe(a);Si=Oi(a);Vi(18E5,2);return a}
function Ui(a,b){var c=new Qi(b);fe("");Si=Pi(c);0<a&&Vi(12E4,a-1);throw c;}
function Vi(a,b){R(function(){wd(Ki().then(Ti,function(c){return Ui(b,c)}),ya)},a)}
function Wi(){try{var a=z("yt.ads.biscotti.getId_");return a?a():ee()}catch(b){return ud(b)}}
;function Xi(a){if("1"!==Va(ce(),"args","privembed")){a&&de();try{Wi().then(function(){},function(){}),R(Xi,18E5)}catch(b){je(b)}}}
;var Z=z("ytglobal.prefsUserPrefsPrefs_")||{};x("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function Yi(){this.f=P("ALT_PREF_COOKIE_NAME","PREF");var a=Xb.get(""+this.f,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
m=Yi.prototype;m.get=function(a,b){Zi(a);$i(a);var c=void 0!==Z[a]?Z[a].toString():null;return null!=c?c:b?b:""};
m.set=function(a,b){Zi(a);$i(a);if(null==b)throw Error("ExpectedNotNull");Z[a]=b.toString()};
m.remove=function(a){Zi(a);$i(a);delete Z[a]};
...
function $i(a){if(/^f([1-9][0-9]*)$/.test(a))throw Error("ExpectedRegexMatch: "+a);}
...
za(Yi);var bj=null,cj=null,dj=null,ej={};function fj(a){var b=a.id;a=a.ve_type;var c=Qg++;a=new Og({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});ej[b]=a;b=Vg();c=Ug();b&&c&&nh(b,c,[a])}
function gj(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(Wg(b,a),a=Ug()))for(var c in ej){var d=ej[c];d&&nh(b,a,[d])}}
function hj(a){ej[a.id]=new Og({trackingParams:a.tracking_params})}
function ij(a){var b=Vg();a=ej[a.id];if(b&&a){a={csn:b,ve:Pg(a),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"};var c={ca:void 0,P:b};"UNDEFINED_CSN"==b?oh("visualElementGestured",a,c):Ag("visualElementGestured",a,Kg,c)}}
function jj(a){a=a.ids;var b=Vg();if(b)for(var c=0;c<a.length;c++){var d=ej[a[c]];if(d){d={csn:b,ve:Pg(d),eventType:1};var e={ca:void 0,P:b};"UNDEFINED_CSN"==b?oh("visualElementShown",d,e):Ag("visualElementShown",d,Kg,e)}}}
...
x("writeEmbed",function(){var a=P("PLAYER_CONFIG",void 0);Xi(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=P("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);P("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");b="player";var d=void 0===d?!0:d;b="string"===typeof b?ac(b):b;var e=Mh+"_"+Da(b),f=Lh[e];f&&d?a&&a.args&&a.args.fflags&&a.args.fflags.includes("web_player_remove_playerproxy=true")?f.api.loadVideoByPlayerVars(a.args||
null):f.loadNewVideoConfig(a):(f=new wh(b,e,a,void 0),Lh[e]=f,lf("player-added",f.api),Uc(f,Ia(Nh,f)));a=f.api;bj=a;a.addEventListener("onScreenChanged",gj);a.addEventListener("onLogClientVeCreated",fj);a.addEventListener("onLogServerVeCreated",hj);a.addEventListener("onLogVeClicked",ij);a.addEventListener("onLogVesShown",jj);d=P("POST_MESSAGE_ID","player");P("ENABLE_JS_API")?dj=new Ii(a):P("ENABLE_POST_API")&&"string"===typeof d&&"string"===typeof c&&(cj=new Ji(window.parent,d,c),dj=new Di(a,cj.h));
...
var kj=ie(function(){var a=Vh(void 0),b;(b=!Q("use_first_tick"))||(b=!("ol"in Vh(void 0)));if(b&&(b="ol",X.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),X.mark(b)),b=T(),a.ol=b,a=ri(),a.gelTicks&&(a.gelTicks.tick_ol=!0),T(),qi()?(fi().tick.ol=void 0,a=Yh(),ji().tick("ol",a,void 0),Zh(),a=!0):a=!1,!a)){if(!z("yt.timing.pingSent_")&&(b=P("TIMING_ACTION",void 0),a=Vh(void 0),z("ytglobal.timingready_")&&b&&a._start&&Uh())){Zh();b=!0;var c=P("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in
a)){b=!1;break}if(b&&!qi()){d=Vh(void 0);c=Xh();e=d._start;var f=P("CSI_SERVICE_NAME","youtube");b={v:2,s:f,action:P("TIMING_ACTION",void 0)};a=c.srt;void 0!==d.srt&&delete c.srt;if(c.h5jse){var g=window.location.protocol+z("ytplayer.config.assets.js");(g=X.getEntriesByName?X.getEntriesByName(g)[0]:null)?c.h5jse=Math.round(c.h5jse-g.responseEnd):delete c.h5jse}d.aft=Uh();var h=Vh(void 0);g=h.pbr;var k=h.vc;h=h.pbs;if(g&&k&&h&&g<k&&k<h&&Xh().yt_pvis&&"youtube"==f){Xh().yt_lt="hot_bg";if(qi()){f="hot_bg";
g=ri();g.gelInfos?g.gelInfos.info_yt_lt=!0:(k={},g.gelInfos=(k.info_yt_lt=!0,k));if("yt_lt"in li){g=li.yt_lt;0<=La(mi,g)&&(f=!!f);"yt_lt"in oi&&"string"===typeof f&&(f=oi.yt_lt+f.toUpperCase());g=g.split(".");h=k={};for(var l=0;l<g.length-1;l++){var p=g[l];h[p]={};h=h[p]}h[g[g.length-1]]=f;f=$h({},k)}else 0<=La(pi,"yt_lt")||(f=new Te("Unknown label logged with GEL CSI"),f.params={label:"yt_lt"},ke(f)),f=void 0;f&&qi()&&(g=fi(),$h(g.info,f),g=ri(),"gelInfos"in g||(g.gelInfos={}),$h(g.gelInfos,f),g=
Yh(),ji().info(f,g))}else fi().info.yt_lt="hot_bg";f=d.vc;g=d.pbs;delete d.aft;c.aft=Math.round(g-f)}for(var n in c)"_"!=n.charAt(0)&&(b[n]=c[n]);d.ps=T();n={};f=[];for(var v in d)"_"!=v.charAt(0)&&(g=Math.round(d[v]-e),n[v]=g,f.push(v+"."+g));b.rt=f.join(",");(v=z("ytdebug.logTiming"))&&v(b,n);v=!!c.ap;Q("debug_csi_data")&&(c=z("yt.timing.csiData"),c||(c=[],Ka("yt.timing.csiData",c)),c.push({page:location.href,time:new Date,args:b}));c="";for(var q in b)b.hasOwnProperty(q)&&(c+="&"+q+"="+b[q]);q=
"/csi_204?"+c.substring(1);if(window.navigator&&window.navigator.sendBeacon&&v){var y=void 0===y?"":y;Se(q,y)||Pe(q,void 0,void 0,void 0,y)}else Pe(q);x("yt.timing.pingSent_",!0,void 0);dh(Sh,new Qh(n.aft+(a||0),void 0))}}fi().tick.ol=void 0}y=Yi.getInstance();v=!!((aj("f"+(Math.floor(119/31)+1))||0)&67108864);q=1<window.devicePixelRatio;document.body&&Zc(document.body,"exp-invert-logo")&&(q&&!Zc(document.body,"inverted-hdpi")?(n=document.body,n.classList?n.classList.add("inverted-hdpi"):Zc(n,"inverted-hdpi")||
(a=Xc(n),Yc(n,a+(0<a.length?" inverted-hdpi":"inverted-hdpi")))):!q&&Zc(document.body,"inverted-hdpi")&&$c());v!=q&&(v="f"+(Math.floor(119/31)+1),n=aj(v)||0,n=q?n|67108864:n&-67108865,0==n?delete Z[v]:(q=n.toString(16),Z[v]=q.toString()),y.save())}),lj=ie(function(){var a=bj;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();P("PL_ATT")&&If.dispose();a=0;for(var b=Bf.length;a<b;a++){var c=Bf[a];if(!isNaN(c)){var d=z("yt.scheduler.instance.cancelJob");d?d(c):S(c)}}Bf.length=0;vf("//static.doubleclick.net/instream/ad_status.js");Cf=!1;O("DCLKSTAT",0);Wc(dj,cj);if(a=bj)a.removeEventListener("onScreenChanged",gj),a.removeEventListener("onLogClientVeCreated",fj),a.removeEventListener("onLogServerVeCreated",hj),a.removeEventListener("onLogVeClicked",ij),a.removeEventListener("onLogVesShown",
jj),a.destroy();ej={}});
window.addEventListener?(window.addEventListener("load",kj),window.addEventListener("unload",lj)):window.attachEvent&&(window.attachEvent("onload",kj),window.attachEvent("onunload",lj));Ka("yt.abuse.player.botguardInitialized",z("yt.abuse.player.botguardInitialized")||Of);Ka("yt.abuse.player.invokeBotguard",z("yt.abuse.player.invokeBotguard")||Pf);Ka("yt.abuse.dclkstatus.checkDclkStatus",z("yt.abuse.dclkstatus.checkDclkStatus")||Ef);
Ka("yt.player.exports.navigate",z("yt.player.exports.navigate")||Xg);Ka("yt.util.activity.init",z("yt.util.activity.init")||ag);Ka("yt.util.activity.getTimeSinceActive",z("yt.util.activity.getTimeSinceActive")||dg);Ka("yt.util.activity.setTimestamp",z("yt.util.activity.setTimestamp")||bg);}).call(this);
